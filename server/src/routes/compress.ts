...
import { validateBody, compressSchema } from '../middleware/validation.js'
...
router.post(
  ...
  async (req: Request, res: Response) => {
    try {
      ...
      if (!result.usedGhostscript) {
        res.setHeader('X-Compression-Warning', 'Ghostscript not available - limited compression')
      }
